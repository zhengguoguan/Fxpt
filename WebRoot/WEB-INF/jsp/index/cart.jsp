...
<html>
 <head>
  ...
  <title>提交订单</title>
  <link rel="stylesheet" href="${pageContext.request.contextPath}/jd/cart1.css" />
  <script type="text/javascript" src="${pageContext.request.contextPath}/js/jquery-1.8.3.js"></script>
  <script type="text/javascript" src="http://res.wx.qq.com/open/js/jweixin-1.0.0.js"></script>
  <script type="text/javascript">
  	var money = ${requestScope.product.cdprice };
         ...
         <div class="pr"> 
          <div class="wbox "> 
           <div class="pro-img pr"> 
            ...
            <img src="${requestScope.product.cdpicturech}"/> </a> 
            <div class="pro-mask"></div> 
           </div> 
           <div class="pro-box"> 
            <a href="javascript:void(0)" class="pro-name"> 
            <p class="text-clamp2 fs26">${requestScope.product.cdname }</p>
             </a> 
            <div class="sn-count"> 
          ...
          <div class="cart-list-opra wbox"> 
           <div class="wbox-flex tr"> 
            <p class="fs26 sn-txt-assertive ofv ">&yen;${requestScope.product.cdprice }</p> 
           </div> 
   ...
   <div class="cart-fixed">
    <div class="wbox pd">
     <div class="wbox-flex sn-txt-muted">
      <div class="fs30">
       合计:
       <i class="sn-txt-assertive">&yen;<span id="userPayAllPrice">${requestScope.product.cdprice }</span></i>
      </div>
     </div>
