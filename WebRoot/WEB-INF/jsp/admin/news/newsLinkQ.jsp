	...
	function delConfirm(id){
		$.layer({
		  ...
		  dialog : {
		      ...
		      btn : ['是','否'],
		      yes : function(){
		          location.href='${ctx}/admin/newsLink/delete/' + id + '.html';
		      },
		      no : function(index){
		         layer.close(index);
		      }
...
<div class="content_box">
  ...
  <br/>
	...
	<td>${sta.index+1}</td>
	        ...
	        <td>
	       <div class="btn_icon">
		          	 <input type="image" src="${ctx}/theme/default/images/edit_icon.png" title="修改" onclick="javascript:location.href='${ctx}/admin/newsLink/update/${o.Id}.html'"/>
		          	</div>
	          	<div class="btn_icon">
