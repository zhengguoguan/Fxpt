...
<form id="add_form" action='<c:if test="${model.id == null}">${ctx}/admin/cdCategories/save.html</c:if><c:if test="${model.id != null}">${ctx}/admin/cdCategories/update/${model.id}.html</c:if>' method="post">
  ...
  <div class="add_info">
   ...
   <h2>商品大类设置</h2>
    <table id="questTable" border="0" cellspacing="0" cellpadding="0"
					class="ListTable">
    <tr>
     <th class="w100">商品大类编号:</th>
     <td>
     	<input id="categoriesdm" name="categoriesdm" type="text" value="${model.categoriesdm}" class="input_a1" maxlength="100" style="width:160px"  />
     </td>
         </tr>
            <tr>
     <th class="w100">商品大类名称:</th>
     <td>
     	 <input id="categoriesmc" name="categoriesmc" type="text" value="${model.categoriesmc}" class="input_a1" maxlength="100" style="width:160px"  />
     </td>
         </tr>
   </table>
