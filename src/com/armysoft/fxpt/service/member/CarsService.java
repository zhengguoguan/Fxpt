 ...
 */
@Service
public class CarsService extends BaseDao {

	private final String nameSpace = "CarsOpt";
	 ...
	 * @return
	 */
	public List<Cars> getByPage(Map<String, Object> params, Pagination pager) {
	...
	public Cars findByKey(Long id) {
		return super.nativeSelectOne(nameSpace + ".findById", id);
	}
	
	public List<Cars> findByOd(String openid) {
	...
	public List<Map<String, Object>> findByOpenId(String openid) {
		Map<String, Object> params = new HashMap<String, Object>();
		params.put("openid", openid);
		return super.nativeList(nameSpace + ".findByOpenId", params);
	}
	
	public Cars findByOpid(Integer pid,String openid) {
		Map<String, Object> params = new HashMap<String, Object>();
		params.put("pid", pid);
		params.put("openid", openid);
		return super.nativeSelectOne(nameSpace + ".findByOpid", params);
	}
	...
	public void deleteByOpenId(String openId) {
		super.nativeDelete(nameSpace+".deleteByOpenId", openId);
	}
