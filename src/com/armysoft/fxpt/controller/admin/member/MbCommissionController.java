...
import com.armysoft.fxpt.service.member.MbCommissionService;




@Controller
@RequestMapping("admin/mbCommission")
public class  MbCommissionController extends BaseController {

	@Resource
	private MbCommissionService service;
	@InitBinder   
	...
	public String getByPage(@PathVariable Integer currentPage,String fzt,String fsfjjyb,String fhymc,String frysjf,String frysje, String fhtqxf,String fhtqxe,String cyqy,String hylbNo,String hyzcNo,String ssq,String fzjgNo,Model model,
		...
		return "admin/member/MbCommissionQ";
	}
	...
	public String detail(@PathVariable("id") Long key, Model model,HttpServletRequest request) {
		...
		return "admin/member/MbCommissionV";
	}
	...
	public String toAdd(Long id,HttpServletRequest request,Model model) {
		...
		MbCommission mb=service.findByKey(id);
		if(mb!=null){
	...
	public String update(@PathVariable("id") Integer key,MbCommission entity, Model model, HttpServletRequest request) {
		entity.setId(key);
		service.update(entity);
		return "redirect:/admin/mbCommission/list/1.html";
	}
	@RequestMapping(value = SAVE)
	public String save(MbCommission entity, Model model, HttpServletRequest request) {
