...
@Controller
@RequestMapping("admin/cdSmallclass")
public class  CdSmallclassController extends BaseController {

	@Resource
	private CdSmallclassService service;
	@Resource
	...
	public String getByPage(@PathVariable Integer currentPage,String fzt,String fsfjjyb,String fhymc,String frysjf,String frysje, String fhtqxf,String fhtqxe,String cyqy,String hylbNo,String hyzcNo,String ssq,String fzjgNo,Model model,
		...
		return "admin/member/CdSmallclassQ";
	}
	...
	public String detail(@PathVariable("id") Long key, Model model,HttpServletRequest request) {
		...
		return "admin/member/CdSmallclassV";
	}
	...
	public String toAdd(Long id,HttpServletRequest request,Model model) {
		Map<String, Object> params = new HashMap<String, Object>();
		request.setAttribute("cd_categories",dlservice.getCdCategories(params));
		Integer countAll=service.getCount(params)+1;
		CdSmallclass mb=service.findByKey(id);
		if(mb!=null){
			model.addAttribute("model", mb);
		}else{
			mb=new CdSmallclass();
			DecimalFormat countFormat=new DecimalFormat("000");
			mb.setCasmallclassdm("XL"+countFormat.format(countAll));
			model.addAttribute("model", mb);
		}
		return "admin/member/CdSmallclassV";
	}
	...
	public String update(@PathVariable("id") Integer key,CdSmallclass entity, Model model, HttpServletRequest request) {
		entity.setId(key);
		service.update(entity);
		return "redirect:/admin/cdSmallclass/list/1.html";
	}
	@RequestMapping(value = SAVE)
	public String save(CdSmallclass entity, Model model, HttpServletRequest request) {
